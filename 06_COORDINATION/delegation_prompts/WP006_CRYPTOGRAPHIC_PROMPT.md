# DELEGATION PROMPT: WP-006 CRYPTOGRAPHIC SECURITY COQ PROOFS
...
```
═══════════════════════════════════════════════════════════════════════════════════════════════════
TASK ID: WP-006-CRYPTOGRAPHIC-SECURITY-COQ-PROOFS
CLASSIFICATION: FORMAL PROOF GENERATION — COQ PROOF ASSISTANT
SECURITY LEVEL: CRITICAL — NO ERRORS PERMITTED
═══════════════════════════════════════════════════════════════════════════════════════════════════

OUTPUT: `CryptographicSecurity.v` with 31 theorems (CRY-001 through CRY-031)
...
═══════════════════════════════════════════════════════════════════════════════════════════════════
NAMES: `cry_001_*` through `cry_031_*`. ZERO Admitted. OUTPUT ONLY COQ FILE. BEGIN NOW:
```
