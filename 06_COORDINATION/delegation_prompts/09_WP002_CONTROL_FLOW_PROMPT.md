# DELEGATION PROMPT: WP-002 CONTROL FLOW INTEGRITY COQ PROOFS
...
```
═══════════════════════════════════════════════════════════════════════════════════════════════════
TASK ID: WP-002-CONTROL-FLOW-INTEGRITY-COQ-PROOFS
CLASSIFICATION: FORMAL PROOF GENERATION — COQ PROOF ASSISTANT
SECURITY LEVEL: CRITICAL — NO ERRORS PERMITTED
MODE: ULTRA KIASU | FUCKING PARANOID | ZERO TRUST | INFINITE TIMELINE
═══════════════════════════════════════════════════════════════════════════════════════════════════

YOU ARE GENERATING A COMPLETE COQ PROOF FILE FOR CONTROL FLOW INTEGRITY.

READ EVERY SINGLE WORD. FOLLOW EVERY INSTRUCTION EXACTLY.
...
Output a SINGLE Coq file named `ControlFlowIntegrity.v` that:

1. Defines a control flow graph model
2. Proves that 15 specific control flow hijacking attacks are IMPOSSIBLE
...
4. EXACT theorem names: `ctl_001_*` through `ctl_015_*`
5. NO markdown formatting in output
...
```bash
coqc ControlFlowIntegrity.v  # Must exit 0
grep -c "Admitted\." ControlFlowIntegrity.v  # Must return 0
grep -c "^Theorem ctl_" ControlFlowIntegrity.v  # Must return 15
```
...
OUTPUT ONLY THE COQ FILE. START WITH `(* ControlFlowIntegrity.v *)`.
BEGIN NOW:
```
