# DELEGATION PROMPT: WP-004 WEB APPLICATION SECURITY COQ PROOFS
...
```
═══════════════════════════════════════════════════════════════════════════════════════════════════
TASK ID: WP-004-WEB-APPLICATION-SECURITY-COQ-PROOFS
CLASSIFICATION: FORMAL PROOF GENERATION — COQ PROOF ASSISTANT
SECURITY LEVEL: CRITICAL — NO ERRORS PERMITTED
MODE: ULTRA KIASU | FUCKING PARANOID | ZERO TRUST | INFINITE TIMELINE
═══════════════════════════════════════════════════════════════════════════════════════════════════

YOU ARE GENERATING A COMPLETE COQ PROOF FILE FOR WEB APPLICATION SECURITY.

OUTPUT: `WebSecurity.v` with 25 theorems (WEB-001 through WEB-025)
...
═══════════════════════════════════════════════════════════════════════════════════════════════════
FORBIDDEN: `Admitted.`, `admit.`, new `Axiom`. NAMES: `web_001_*` through `web_025_*`
OUTPUT ONLY COQ FILE. START WITH `(* WebSecurity.v *)`. BEGIN NOW:
```
