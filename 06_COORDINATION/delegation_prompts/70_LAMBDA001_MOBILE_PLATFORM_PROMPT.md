# DELEGATION PROMPT: LAMBDA-001 MOBILE PLATFORM SECURITY COQ PROOFS
...
```
=======================================================================================================
TASK ID: LAMBDA-001-MOBILE-PLATFORM-COQ-PROOFS
...
Domain: Lambda (Mobile Platform Security)
Focus: Verified mobile operating system security

Core Principle: "Every app isolated. Every permission verified."
...
- Secure IPC
- Keystore protection
- Biometric authentication correctness

=======================================================================================================
SECTION 2: WHAT YOU MUST PRODUCE
=======================================================================================================

You MUST output a SINGLE Coq file named `MobilePlatform.v` that:

1. Defines application sandbox model
2. Defines permission system with capability tokens
3. Proves that 25 specific mobile security properties hold
...
1. DO NOT change theorem names - use EXACTLY `mobile_001_*` through `mobile_025_*`
...
Your output will be saved to `MobilePlatform.v` and these checks will be run:

```bash
# Check 1: Must compile
coqc MobilePlatform.v
# Exit code MUST be 0

# Check 2: Count Admitted (must be 0)
grep -c "Admitted\." MobilePlatform.v
# MUST return 0

# Check 3: Count admit tactic (must be 0)
grep -c "admit\." MobilePlatform.v
# MUST return 0

# Check 4: Count theorems (must be 25)
grep -c "^Theorem mobile_" MobilePlatform.v
# MUST return 25

# Check 5: No new axioms
grep -c "^Axiom" MobilePlatform.v
# MUST return 0
```
...
START YOUR OUTPUT WITH `(* MobilePlatform.v *)` AND END WITH THE FINAL LINE OF THE FILE.
