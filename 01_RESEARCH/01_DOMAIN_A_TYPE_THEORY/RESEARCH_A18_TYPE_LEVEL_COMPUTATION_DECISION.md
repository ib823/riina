...
├─────────────────────────────────────────────────────────────┤
│                                                              │
│  Source → Parse → Elaborate → TL-Eval → Check → Erase → Gen │
│                        │          │        │                 │
│                        ▼          ▼        ▼                 │
│                   Universe    Normalize  Verify              │
│                   Inference   Types      Terms               │
│                        │          │        │                 │
│                        ▼          ▼        ▼                 │
│                   Implicit    Term.      Proof               │
│                   Resolution  Check      Erase               │
│                                                              │
└─────────────────────────────────────────────────────────────┘
```
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Types:
    - All type parameters → erased (exist only at compile time)
    
Proofs:
    - Equality proofs → erased (Refl has no runtime rep)
    - Constraint witnesses → erased if not used
    
Singletons:
    - SNat<n> → erased (type determines value)
    - Exception: if singleton value used at runtime, keep
    
PhantomData:
    - PhantomData<T> → zero-sized (no runtime rep)
    
Result:
    - Type-level computation → zero runtime cost
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
