...
```
Value-Level:    add : Int → Int → Int
                add 2 3 = 5

Type-Level:     Add : Nat → Nat → Nat       (types are "values")
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
1970s   │ Martin-Löf Type Theory (dependent types foundation)
1988    │ Constable's Nuprl (computational type theory)
1990s   │ Cayenne (dependent types in practical language)
2000    │ McBride's "Faking It" (simulating dependent types)
2005    │ Haskell type families proposal
2008    │ TypeFamilies extension in GHC
2010    │ DataKinds promotion in GHC
2012    │ Agda/Idris mature implementations
2014    │ Singletons library for Haskell
2016    │ TypeScript conditional types
2019    │ Rust const generics
2020+   │ Advanced type-level programming widespread
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
Label Lattice Operations:
    Join : Label → Label → Label    (least upper bound)
    Meet : Label → Label → Label    (greatest lower bound)
    Flows : Label → Label → Bool    (information flow check)

Indexed Data:
    Labeled : Label → Type → Type
    
Compile-Time Flow Check:
    assign : Flows from to ≡ True ⊢ Labeled from a → Labeled to a
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
Transition Validity:
    ValidTrans : ConnState → ConnState → Bool
    
State-Indexed Connection:
    Connection : ConnState → Type
    
Operations change state:
    connect : Connection Disconnected → IO (Connection Connecting)
    establish : Connection Connecting → IO (Connection Connected)
    send : Connection Connected → Data → IO ()
    close : Connection s → IO (Connection Closed)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
├── Security label lattice (Join, Meet, Flows)
├── Permission set operations (HasCap, Union, Subtract)
└── State machine validation (ValidTransition)

Priority 2 (Type Safety):
├── Length-indexed vectors
├── Capability-indexed monads
