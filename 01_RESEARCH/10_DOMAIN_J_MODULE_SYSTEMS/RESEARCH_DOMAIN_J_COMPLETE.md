...
Source Files → Parsing → AST → Type Checking → IR → Optimization → Object Code
                                    ↓
...
*Research Track Output — Domain J: Module Systems and Namespaces*
