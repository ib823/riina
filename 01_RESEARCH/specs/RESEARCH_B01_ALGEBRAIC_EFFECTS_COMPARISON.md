...
|---------|-----|------|-------|---------|--------|-------|
| Deep handlers | âœ“ | âœ“ | âœ“ | Manual | âœ“ | âœ“ |
| Shallow handlers | âœ“ | âœ“ | âœ— | âœ“ | âœ— | âœ“ |
| Effect polymorphism | âœ“ | âœ“ | âœ“ | âœ— | âœ“ | âœ“ |
| Effect inference | â— | âœ“ | âœ“ | âœ— | âœ“ | âœ“ |
| Row effects | âœ— | âœ“ | â— | âœ— | â— | âœ“ |
| Multi-shot cont. | âœ“ | âœ“ | âœ“ | âœ— | âœ— | âœ“ |
| Named instances | âœ“ | âœ“ | âœ— | âœ— | âœ“ | âœ— |
| Parameterized handlers | âœ“ | âœ“ | âœ“ | Manual | âœ“ | âœ“ |

### 2.2 Type System Features

| Feature | Eff | Koka | Frank | OCaml 5 | Effekt | Links |
|---------|-----|------|-------|---------|--------|-------|
| Effect rows | âœ— | âœ“ | Implicit | âœ— | â— | âœ“ |
| Effect subtyping | âœ— | âœ“ | âœ— | âœ— | âœ“ | âœ“ |
| Higher-kinded effects | âœ— | âœ— | âœ— | âœ— | âœ— | âœ— |
| Dependent effects | âœ— | âœ— | âœ— | âœ— | âœ— | âœ— |
| Linear effects | âœ— | â— | âœ— | â— | âœ“ | âœ— |
| Scoped effects | âœ“ | âœ“ | âœ— | âœ— | âœ“ | âœ— |
...
| Tail-resumptive opt | âœ— | âœ“ | âœ— | âœ— | âœ“ |
...
```
Eff Implementation:
â”œâ”€â”€ Syntax: ML-like with effect operations
â”œâ”€â”€ Type System: Bidirectional with effect inference
â”œâ”€â”€ Runtime: Continuation-based
â”œâ”€â”€ Handlers: Deep, first-class
â””â”€â”€ Resources: Effect instances with identity
```
...
```
Koka Implementation:
â”œâ”€â”€ Syntax: ML/Haskell hybrid
â”œâ”€â”€ Type System: Row-polymorphic effects
â”œâ”€â”€ Runtime: Evidence passing (FBIP)
â”œâ”€â”€ Handlers: Deep with tail-resumptive opt
â””â”€â”€ Memory: Perceus reference counting
```
...
â”œâ”€â”€ Syntax: Functional with operators
â”œâ”€â”€ Type System: Bidirectional, abilities
â”œâ”€â”€ Runtime: Continuation-based
â”œâ”€â”€ Handlers: Implicit, pattern-matching style
â””â”€â”€ Features: Operators in types
```
...
â”œâ”€â”€ Syntax: OCaml + effect keyword
â”œâ”€â”€ Type System: Untyped effects (!)
â”œâ”€â”€ Runtime: Fiber-based continuations
â”œâ”€â”€ Handlers: Shallow by default
â””â”€â”€ Features: Parallelism support
```
...
â”œâ”€â”€ Syntax: Scala-like
â”œâ”€â”€ Type System: Capability-based effects
â”œâ”€â”€ Runtime: Capability passing (ANF + CPS)
â”œâ”€â”€ Handlers: Lexically scoped
â””â”€â”€ Features: Multi-backend (JS, LLVM, Chez)
```
...
Code generation:
    ...
    â†’ fun foo(ev: Evidence<state>): int  // tail-resumptive
    â†’ fun foo(ev: Evidence<state>, k: Cont): void  // general
```
...
Code generation:
    def foo(): Int / State
    â†’ def foo(cap: Capability[State]): Int
```
...
Code generation:
    perform E
    â†’ switch_to_handler_fiber(E, current_fiber)
```
...
|--------|---------------------|-------|
| Eff | âœ“ Can implement | Via resources |
| Koka | âœ“ Can implement | Via handlers |
| Frank | âœ“ Can implement | Via operators |
| OCaml 5 | â— Can implement | No type safety |
| Effekt | âœ“ Can implement | Via capabilities |
...
|------|-----|------|-------|---------|--------|
| IDE support | â— | âœ“ | âœ— | âœ“âœ“ | â— |
| Debugger | âœ— | â— | âœ— | âœ“ | âœ— |
| Profiler | âœ— | â— | âœ— | âœ“ | âœ— |
| Package manager | âœ— | âœ“ | âœ— | âœ“âœ“ | â— |
| Documentation | â— | âœ“ | â— | âœ“âœ“ | âœ“ |
...
|-------------|-----|------|-------|---------|--------|
| Effect typing | âœ“ | âœ“âœ“ | âœ“ | âœ—âœ— | âœ“ |
| Performance | âœ— | âœ“âœ“ | âœ— | âœ“ | âœ“ |
| Security effects | âœ“ | âœ“ | âœ“ | â— | âœ“ |
| Linear integration | âœ— | â— | âœ— | â— | âœ“ |
| Row polymorphism | âœ— | âœ“âœ“ | â— | âœ— | â— |
| Formal foundation | âœ“âœ“ | âœ“ | âœ“âœ“ | â— | âœ“ |
