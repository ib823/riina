...
|---------|------------|------------|-------|------------|------|---------|
| Type-level functions | âœ“ Families | âœ“ Auto | âœ“ Native | âœ“ Conditional | â— Limited | âœ“ Match |
| Type-level data | âœ“ DataKinds | âœ“ Promoted | âœ“ Native | â— Literals | â— Const | âœ“ Singleton |
| Type-level arithmetic | âœ“ Plugins | âœ“ Auto | âœ“ Native | â— Tuple hack | âœ“ Const gen | âœ“ Match |
| Type-level strings | âœ“ Symbol | âœ“ Symbol | âœ“ Native | âœ“ Template | âœ— | âœ“ Singleton |
| Type-level lists | âœ“ Promoted | âœ“ Promoted | âœ“ Native | âœ“ Tuples | â— Typenum | âœ“ Tuples |
| Recursion | âœ“ | âœ“ | âœ“ | â— Limited depth | â— Traits | âœ“ |

### 2.2 Type-Value Bridging

| Feature | Haskell TF | Singletons | Idris | TypeScript | Rust | Scala 3 |
|---------|------------|------------|-------|------------|------|---------|
| Singletons | Manual | âœ“ Auto | âœ“ Native | âœ— | Manual | âœ“ Native |
| Reflection | âœ“ Typeable | âœ“ Auto | âœ“ Native | âœ— | âœ— | âœ“ Mirrors |
| Reification | Manual | âœ“ Auto | âœ“ Native | âœ— | âœ— | âœ“ Auto |
| Runtime dispatch | âœ“ Dict | âœ“ Dict | âœ“ Native | âœ— | âœ“ dyn | âœ“ Givens |

### 2.3 Expressiveness

| Feature | Haskell TF | Singletons | Idris | TypeScript | Rust | Scala 3 |
|---------|------------|------------|-------|------------|------|---------|
| Higher-order type fns | â— Defunc | âœ“ Defunc | âœ“ Native | âœ— | âœ— | âœ“ Native |
| Type-level lambdas | âœ— | âœ“ Via TH | âœ“ Native | âœ— | âœ— | âœ“ Native |
| Partial application | âœ“ | âœ“ | âœ“ Native | â— Limited | âœ— | âœ“ Native |
| Pattern matching | âœ“ | âœ“ | âœ“ Native | âœ“ Conditional | â— Traits | âœ“ Match |
| Overlapping patterns | âœ“ Closed | âœ“ | âœ“ | âœ“ | âœ— | âœ“ |

### 2.4 Soundness and Safety

| Feature | Haskell TF | Singletons | Idris | TypeScript | Rust | Scala 3 |
|---------|------------|------------|-------|------------|------|---------|
| Termination checking | â— UndecidableInstances | â— | âœ“ Total | âœ— | âœ“ Trait limits | â— |
| Confluence | âœ“ Closed | âœ“ | âœ“ | âœ— | âœ“ | â— |
| Type soundness | âœ“ | âœ“ | âœ“ | âœ— | âœ“ | âœ“ |
| Injectivity | âœ“ Annotation | âœ“ | âœ“ | âœ— | N/A | â— |
...
|--------|---------------|----------------|-----------------|
| Haskell TF | Good | Poor | âœ“ TypeError |
| Singletons | Poor | Very Poor | âœ“ Via TF |
| Idris | Good | Good | âœ“ Native |
| TypeScript | Good | Medium | âœ— |
| Rust | Good | Medium | âœ— |
| Scala 3 | Good | Medium | âœ“ |
...
|--------|----------------|----------------------|----------------|
| Haskell TF | GADTs/DataKinds | Type family | âœ“ |
| Singletons | Auto GADTs | Auto type family | âœ“ |
| Idris | Indexed types | Dependent types | âœ“ |
| TypeScript | Discriminated unions | Conditional | â— |
| Rust | State types | PhantomData | âœ“ |
| Scala 3 | Enums/GADTs | Match types | âœ“ |
...
Security Builtins:
    - Label : Type â†’ Type (for IFC)
    - Cap : Type â†’ Type (for capabilities)
    - State : Type â†’ Type â†’ Type (for state machines)
â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”
```
...
â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”
Label Lattice:
    join : (l1 : Label) â†’ (l2 : Label) â†’ Label
    meet : (l1 : Label) â†’ (l2 : Label) â†’ Label
    flows : (l1 : Label) â†’ (l2 : Label) â†’ Bool

Capability Sets:
    has : Cap â†’ CapSet â†’ Bool
    union : CapSet â†’ CapSet â†’ CapSet
    subtract : CapSet â†’ CapSet â†’ CapSet
    subset : CapSet â†’ CapSet â†’ Bool

State Machines:
    validTransition : (from : State) â†’ (to : State) â†’ Bool
    reachable : (init : State) â†’ (target : State) â†’ Bool
