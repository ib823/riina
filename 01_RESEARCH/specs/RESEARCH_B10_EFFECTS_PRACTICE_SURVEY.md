...
â”œâ”€â”€ Used in research projects at MSR
â”œâ”€â”€ Perceus GC enables predictable performance
â”œâ”€â”€ FBIP achieves near-C performance for many patterns
â”œâ”€â”€ Effect inference reduces annotation burden
â”œâ”€â”€ Challenge: Learning curve for developers
â””â”€â”€ Challenge: Ecosystem size
```
...
```
OCaml 5 Deployment:
â”œâ”€â”€ Shipped in OCaml 5.0 (December 2022)
â”œâ”€â”€ Used for Eio (effects-based I/O)
â”œâ”€â”€ Multicore parallelism built on effects
â”œâ”€â”€ Challenge: No effect typing (!)
â”œâ”€â”€ Challenge: One-shot continuations only
â””â”€â”€ Benefit: Huge existing ecosystem
```
...
â”œâ”€â”€ Fastest Haskell extensible effects
â”œâ”€â”€ Used in production at various companies
â”œâ”€â”€ Near-native IO performance
â”œâ”€â”€ Challenge: Still has overhead vs raw IO
â”œâ”€â”€ Challenge: Learning curve from mtl

polysemy, fused-effects:
â”œâ”€â”€ Good ergonomics
â”œâ”€â”€ Slower than effectful
â”œâ”€â”€ Better type errors
...
Findings:
â”œâ”€â”€ Effect inference critical for adoption
â”‚   - 85% preferred inferred over annotated
â”‚   - Manual annotation seen as "too verbose"
â”‚
â”œâ”€â”€ Error messages major pain point
â”‚   - 60% struggled with effect-related errors
â”‚   - Row type errors particularly confusing
â”‚
â”œâ”€â”€ Handler concept learnable
â”‚   - Average: 2-3 hours to grasp basics
â”‚   - Week to feel "productive"
â”‚
â””â”€â”€ Benefits recognized
...
â”œâ”€â”€ Define main effect interfaces
â”œâ”€â”€ Implement production handlers
â”œâ”€â”€ Migrate critical paths
â””â”€â”€ Keep rest unchanged

Phase 2: Expand Coverage (Month 3-4)
â”œâ”€â”€ Add effects to more modules
â”œâ”€â”€ Create test handlers
â”œâ”€â”€ Train team
...
â”œâ”€â”€ Optimize handlers
â””â”€â”€ Establish guidelines
```
...
âœ“ Effect tracking catches bugs early
âœ“ Testing dramatically improved
âœ“ Security boundaries clearer
âœ“ Modular, composable code
âœ“ Performance competitive when optimized
âœ“ Team productivity long-term
```
...
âœ— Steep initial learning curve
âœ— Error messages often confusing
âœ— Tooling still immature
âœ— Performance debugging hard
âœ— Ecosystem fragmentation
âœ— Higher-order effects tricky
```
...
â”œâ”€â”€ Foundation: Algebraic effects with handlers
â”œâ”€â”€ Types: Row-polymorphic effect types
â”œâ”€â”€ Compilation: Evidence passing (Koka-style)
â”œâ”€â”€ Inference: Full effect inference
â”œâ”€â”€ Security: Scoped handlers, coeffects
â”œâ”€â”€ Performance: Tail-resumptive optimization
â””â”€â”€ Practice: Production-ready handlers
```
...
**Domain B: Effect Systems â€” COMPLETE**
