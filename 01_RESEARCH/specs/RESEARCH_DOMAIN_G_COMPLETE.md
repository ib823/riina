...
â”œâ”€â”€ ML-KEM (Kyber): Key encapsulation
â”œâ”€â”€ ML-DSA (Dilithium): Digital signatures
â”œâ”€â”€ SLH-DSA (SPHINCS+): Hash-based signatures
â””â”€â”€ (Future) FN-DSA (Falcon): Signatures
...
â”œâ”€â”€ HACL* (F*): AES, ChaCha20, Poly1305, Curve25519, SHA2/3
â”œâ”€â”€ Jasmin: Assembly-level verification
â”œâ”€â”€ Fiat-Crypto: Field arithmetic
â”œâ”€â”€ AWS-LC: Partial verification
â””â”€â”€ Vale: Verified assembly
```
...
```
Side Channels:
â”œâ”€â”€ Timing: Variable execution time
â”œâ”€â”€ Cache: Memory access patterns
â”œâ”€â”€ Power: Energy consumption
â”œâ”€â”€ EM: Electromagnetic emanations
â””â”€â”€ Fault: Induced errors
```
...
Root Key (HSM-protected)
    â”‚
    â”œâ”€â”€ Master Key Encryption Key (KEK)
    â”‚       â”‚
    â”‚       â”œâ”€â”€ Data Encryption Keys (DEK)
    â”‚       â”‚       â”œâ”€â”€ File encryption
    â”‚       â”‚       â”œâ”€â”€ Database encryption
    â”‚       â”‚       â””â”€â”€ Communication encryption
    â”‚       â”‚
    â”‚       â””â”€â”€ Key Wrapping Keys
    â”‚
    â”œâ”€â”€ Master Signing Key
    â”‚       â”‚
    â”‚       â”œâ”€â”€ Code Signing Key
    â”‚       â”œâ”€â”€ Document Signing Key
    â”‚       â””â”€â”€ Certificate Signing Key
    â”‚
    â””â”€â”€ Master Agreement Key
            â”‚
            â”œâ”€â”€ TLS Keys
            â””â”€â”€ Key Exchange Keys
```
...
*Research Track Output â€” Domain G: Cryptographic Foundations*
