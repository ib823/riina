...
â”œâ”€â”€ Effects as first-class types
â”œâ”€â”€ Row polymorphism for effect composition
â”œâ”€â”€ Evidence passing for performance
â”œâ”€â”€ Functional But In-Place (FBIP)
â”œâ”€â”€ Perceus: Precise reference counting
â””â”€â”€ Minimal runtime, maximum safety
```
...
2012    â”‚ Initial Koka development (Leijen)
2014    â”‚ "Koka: Programming with Row Polymorphic Effect Types"
2016    â”‚ Effect handlers added
2017    â”‚ "Type Directed Compilation" paper
2020    â”‚ FBIP and Perceus memory management
2021    â”‚ Koka v2 release
2022    â”‚ Evidence passing refinements
2023    â”‚ Continued optimization work
2024    â”‚ Production-ready compiler
â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”
```
...
```koka
// Effect row syntax
// <e1, e2, ... | Îµ>  where Îµ is row variable
...
```koka
// Row variable Îµ captures "rest of effects"
...
// <e1, e2|Îµ> âˆª <e3|Îµ> = <e1, e2, e3|Îµ>
```
...
Application:
    Î“ âŠ¢ eâ‚ : Ï„â‚ â†’ Îµ Ï„â‚‚    Î“ âŠ¢ eâ‚‚ : Ï„â‚ ! Îµ'
    â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    Î“ âŠ¢ eâ‚ eâ‚‚ : Ï„â‚‚ ! Îµ âˆª Îµ'

Effect operation:
    op : Ï„â‚ â†’ Ï„â‚‚ âˆˆ E
    â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    Î“ âŠ¢ op : Ï„â‚ â†’ âŸ¨E|ÏâŸ© Ï„â‚‚

Handler:
    Î“ âŠ¢ e : Ï„ ! âŸ¨E|ÎµâŸ©
    Î“ âŠ¢ h handles E to Ï„' ! Îµ
    â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    Î“ âŠ¢ with h handle e : Ï„' ! Îµ
```
...
Tail-resumptive:
    ctl get() -> resume(current)      âœ“
    ctl put(x) -> { s := x; resume(()) }  âœ“

Not tail-resumptive:
    ctl choose() -> resume(True) ++ resume(False)  âœ—
```
...
Features:
â”œâ”€â”€ Compile-time reference count insertion
â”œâ”€â”€ No tracing GC needed
â”œâ”€â”€ Predictable performance
â”œâ”€â”€ Memory reuse optimization
â””â”€â”€ Drop specialization
