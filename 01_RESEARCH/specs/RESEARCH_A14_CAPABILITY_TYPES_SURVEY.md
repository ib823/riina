...
Capability â‰ˆ Unforgeable + Transferable + Authority
...
Capability Derivation:
  parent_cap â†’ child_cap (with subset of rights)
...
Bounded Capabilities:
  Cap<R> at Ï    -- capability valid in region Ï
  
Parameterized:
  âˆ€Î±. Cap<Î±>     -- polymorphic capability
```
...
Introduction (creation):
  Î“ âŠ¢ create[R] : Cap<R> ! {Create<R>}
  -- Creating capability requires Create effect
  
Elimination (use):
  Î“ âŠ¢ c : Cap<R>    Î“ âŠ¢ op : R â†’ Ï„
  â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  Î“ âŠ¢ use(c, op) : Ï„ ! {Use<R>}
...
Linearity:
  Î“ âŠ¢ c : lin Cap<R>    Î”, x : lin Cap<R> âŠ¢ e : Ï„
  â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  Î“ âŠ— Î” âŠ¢ let x = c in e : Ï„
```
...
Unforgeability:
  If Î“ âŠ¬ cap : Cap<R> at time t
  Then Î“ cannot use R at time t
  (Cannot create capabilities from nothing)
  
Monotonicity:
  If Î“ âŠ¢ cap : Cap<R, P>
  Then attenuate(cap) : Cap<R, P'> where P' âŠ† P
...
Region Scoping:
  letregion Ï in
    letcap c : cap<File> at Ï = open_file(path) in
      use(c, read)
    end
...
Handler Pattern:
  handle {
    ...
    Create() â†’ resume(create_real_resource()),
    Use(c) â†’ resume(use_real_resource(c)),
    Drop(c) â†’ resume(drop_real_resource(c)),
  }
```
...
2. Permission Model
   - Lattice-based (File: Read âŠ† Full)?
