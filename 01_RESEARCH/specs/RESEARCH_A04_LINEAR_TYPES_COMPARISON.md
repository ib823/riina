...
|----------|--------|--------|----------|---------|
| **Use count** | =1 | â‰¤1 | â‰¥1 | =1 |
| **Can duplicate** | âœ— | âœ— | âœ“ | âœ— |
| **Can discard** | âœ— | âœ“ | âœ— | âœ— |
| **Can reorder** | âœ“ | âœ“ | âœ“ | âœ— |
| **Key safety** | â˜…â˜…â˜… | â˜…â˜…â˜† | â˜…â˜†â˜† | â˜…â˜…â˜… |
| **Audit safety** | â˜…â˜…â˜† | â˜…â˜†â˜† | â˜…â˜…â˜… | â˜…â˜…â˜† |
| **Ergonomics** | â˜…â˜†â˜† | â˜…â˜…â˜… | â˜…â˜…â˜† | â˜†â˜†â˜† |
...
| **Borrowing** | âœ“ | âœ— | âœ“ | âœ— |
| **Lifetimes** | Explicit | Implicit | Explicit | Implicit |
| **Dependent types** | âœ— | âœ— | âœ“ | Limited |
...
type PrivateKey âŠ¸
derive : Seed âŠ¸ PrivateKey
sign : PrivateKey âŠ— Message â†’ PrivateKey âŠ— Signature
destroy : PrivateKey âŠ¸ ()
```
- âœ“ No key duplication
- âœ“ Explicit destruction required
- âœ— Cannot temporarily share for operations
...
```
- âœ“ Practical borrowing for operations
- âœ— Keys could be leaked (mem::forget)
- âœ— No guarantee of use
...
|----------|------------|-------------|---------|------------|
| Linear caps | âœ“ | âœ“ | âœ— | âœ“ |
| Affine caps | âœ— | âœ“ | âœ— | âœ“ |
| Object caps | âœ“ | âœ“ | âœ— | âœ“ |
...
**TERAS Need:** Hybrid approachâ€”linear for structure, runtime for revocation.
...
type Connection{s:State} where
    s âˆˆ {Idle, Handshaking, Established, Closed}
```
...
|--------|-------------------|----------------|
| Rust (NLL) | O(nÂ³) worst case | 10-30% of compile time |
...
- Performance â‰¥ equivalent hand-written C
...
- Affine (â‰¤1): At most once (default for resources)
- Relevant (â‰¥1): At least once (audit entries)
- Unrestricted (Ï‰): Freely copyable (immutable data)

Type Grammar:
Ï„ ::= T                     -- base type
    | Ï„ âŠ¸ Ï„                 -- linear function
    | Ï„ â†’ Ï„                 -- unrestricted function  
    | Ï„ âŠ— Ï„                 -- linear pair
    | Ï„ & Ï„                 -- with (choice)
    | !Ï„                    -- unrestricted
    | &Ï„                    -- shared borrow
    | &mut Ï„                -- mutable borrow
    | Linear Ï„              -- explicitly linear
    | Relevant Ï„            -- must-use
```
...
type SecureKey = Linear {k: Key | level(k) â‰¥ Secret}
