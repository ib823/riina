...
â”œâ”€â”€ Effects as "abilities" (bidirectional)
â”œâ”€â”€ Operators in types (interface declarations)
â”œâ”€â”€ Implicit handler invocation
â”œâ”€â”€ Call-by-push-value foundation
â”œâ”€â”€ Pattern matching on computations
â””â”€â”€ Do-be-do-be-do (thunk/computation distinction)
```
...
â”œâ”€â”€ Capabilities as values
â”œâ”€â”€ Lexically scoped effects
â”œâ”€â”€ Second-class continuations
â”œâ”€â”€ Multi-backend compilation (JS, LLVM, Chez)
â”œâ”€â”€ Efficient capability passing
â””â”€â”€ Effect safety through lexical scope
```
...
```
Effekt Backends:
â”œâ”€â”€ JavaScript (primary)
â”‚   â””â”€â”€ CPS transformation
â”œâ”€â”€ LLVM
â”‚   â””â”€â”€ Stack manipulation
â”œâ”€â”€ Chez Scheme
â”‚   â””â”€â”€ Native continuations
â””â”€â”€ (experimental) ML backend
...
4. BrachthÃ¤user, J., et al. (2022). "Effekt: Capability-passing Style for Type- and Effect-safe, Extensible Effect Handlers"
