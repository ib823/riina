...
|---------|-----|------|-------|---------------|----------|-----------|
| Effect abstraction | âœ“ | âœ“ | âœ“ | âœ“ | âœ“ | âœ“ |
| Effect composition | Stacks | Sum types | Union | Carrier | Union | Union |
| Effect polymorphism | Classes | âœ— | âœ“ | âœ“ | âœ“ | âœ“ |
| Multiple interp. | âœ— | âœ“ | âœ“ | âœ“ | âœ“ | âœ“ |
| Local effects | âœ— | âœ— | â— | âœ“ | âœ“ | âœ“ |
| Higher-order effects | N/A | â— | â— | âœ“ | âœ“ | âœ“ |

### 2.2 Type System Features

| Feature | MTL | Free | Freer | fused-effects | polysemy | effectful |
|---------|-----|------|-------|---------------|----------|-----------|
| Functional deps | âœ“ | âœ— | âœ— | âœ“ | âœ— | âœ— |
| Type families | â— | âœ— | âœ“ | âœ“ | âœ“ | âœ“ |
| Type-level lists | âœ— | âœ— | âœ“ | âœ“ | âœ“ | âœ“ |
| GADTs | âœ— | â— | âœ“ | âœ“ | âœ“ | âœ“ |
| Rank-N types | âœ“ | âœ“ | âœ“ | âœ“ | âœ“ | âœ“ |
...
|---------|---------------------|-------------|
| MTL | WriterT-based | âœ“ |
| Free | Custom functor | âœ“ |
| Freer | Effect in union | âœ“ |
| effectful | Dynamic effect | âœ“ |

### 5.2 Capability Checking

| Library | Static Caps | Dynamic Caps | Type-Level |
|---------|-------------|--------------|------------|
| MTL | Via constraints | Runtime | âœ“ |
| Freer | Union membership | Handler | âœ“ |
| effectful | Effect presence | Handler | âœ“ |
...
**Do NOT use monadic effects as primary** â€” Use algebraic effects (B-01)
