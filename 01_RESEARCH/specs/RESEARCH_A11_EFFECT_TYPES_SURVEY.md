...
```
Ï„ ::= Int | Bool | Ï„â‚ â†’^Îµ Ï„â‚‚    (types)
Îµ ::= {Îµâ‚, Îµâ‚‚, ...}             (effect sets)

Typing rule for application:
Î“ âŠ¢ eâ‚ : Ï„â‚ â†’^Îµ Ï„â‚‚ !Îµâ‚
Î“ âŠ¢ eâ‚‚ : Ï„â‚ !Îµâ‚‚
â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
Î“ âŠ¢ eâ‚ eâ‚‚ : Ï„â‚‚ !(Îµâ‚ âˆª Îµâ‚‚ âˆª Îµ)
```
...
1. **Effect Signature (Î£):** A set of operation symbols with arities
   ```
   Î£ = {opâ‚ : Aâ‚ â†’ Bâ‚, opâ‚‚ : Aâ‚‚ â†’ Bâ‚‚, ...}
   ```

2. **Free Monad Interpretation:** Algebraic effects correspond to the free monad over the effect signature
   ```
   Free Î£ A = Return A | Op (âˆƒop âˆˆ Î£. A_op Ã— (B_op â†’ Free Î£ A))
   ```
...
```
Ï ::= âŸ¨âŸ©                    (empty row)
    | âŸ¨l : Ï„ | ÏâŸ©           (row extension)
    | Î±                      (row variable)

Effect rows:
Îµ ::= âŸ¨âŸ©                    (pure)
    | âŸ¨l | ÎµâŸ©               (effect extension)
    | Îµ                      (effect variable)
```
...
[APP]
Î“ âŠ¢ eâ‚ : Ï„â‚ â†’ Ï„â‚‚ ! Îµâ‚
Î“ âŠ¢ eâ‚‚ : Ï„â‚ ! Îµâ‚‚
â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
Î“ âŠ¢ eâ‚ eâ‚‚ : Ï„â‚‚ ! (Îµâ‚ âˆª Îµâ‚‚)

[HANDLE]
Î“ âŠ¢ e : Ï„ ! âŸ¨l | ÎµâŸ©
h handles l returning Ï„'
â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
Î“ âŠ¢ handle_l e with h : Ï„' ! Îµ
```
...
Effekt is a research language by Jonathan BrachthÃ¤user et al. at UniversitÃ¤t TÃ¼bingen where effects are treated as capabilities.
...
```
Effect formulas:
Ï† ::= âŠ¤ (impure) | âŠ¥ (pure) | Î± (variable)
    | Ï†â‚ âˆ§ Ï†â‚‚ | Ï†â‚ âˆ¨ Ï†â‚‚ | Â¬Ï†
...
â”‚ main   â”‚ â†â”€â”€ â”‚ fiber1 â”‚ â†â”€â”€ â”‚ fiber2 â”‚ â† stack pointer
...
fn process_secret(x: Secret<Data>) -> Public<Hash>
  // Effect system tracks secret â†’ public flow
...
4. BrachthÃ¤user, J.I., et al. (2020). "Effects as capabilities." OOPSLA 2020.
