...
### Session A-13: Ownership Types â€” Architecture Decision
...
```
Must integrate with:
  A-04: Linear Types     - Ownership â‰ˆ affine types
...
Syntax:
  ...
  &'Ï x     -- borrow with explicit lifetime
  &'Ï mut x -- mutable borrow with lifetime
```
...
With Lifetimes:
  ...
  owned T at Ï            -- owned in region Ï

Full Form:
  [lin|aff] [uniq] owned T [at Ï] [! E]
```
...
Read âŠ† Write âŠ† Own
Consume âŸ‚ Read  (cannot read consumed)

Splitting:
  Own<T> â†’ Read<T> âŠ— Write<T>
  
Merging:
  Read<T> âŠ— Write<T> â†’ Own<T>
  (only if same value)

Transfer:
  Own<T> âŠ¸ Consume<T>  (consuming transfer)
```
...
owned T      â‰¡  aff T + Drop
lin owned T  â‰¡  lin T + explicit_consume
&T           â‰¡  duplicable ref
&mut T       â‰¡  lin ref (exclusive)

Combined Typing Rules:

Î“ âŠ¢ e : owned T    Î”, x : owned T âŠ¢ e' : Ï„
â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€  (let-owned)
        Î“, Î” âŠ¢ let x = e in e' : Ï„

Î“ âŠ¢ e : lin owned T    Î”, x : lin owned T âŠ¢ e' : Ï„
â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€  (let-lin-owned)
        Î“ âŠ— Î” âŠ¢ let x = e in e' : Ï„
```
...
Rules:
  ...
  owned T âŠ¥ shared<T>          (incompatible)
  uniq owned T â†’ shared<T>     (forbidden)
```
...
owned T at Ï:
  - Value owned AND in region Ï
  - Cleanup: min(owner scope, region end)
  
&'Ï T:
  - Borrow from region Ï
...
Type Rules:
  Î“ âŠ¢ e : owned T at Ï    Ï âˆˆ Î“
  â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  Î“ âŠ¢ &e : &'Ï T

  cap : lin Cap<Ï>    Î“ âŠ¢ e : owned T at Ï
  â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  Î“ âŠ¢ drop(e, cap) : () ! {Free<Ï>}
```
...
Effect Composition:
  Î“ âŠ¢ e : owned T ! Eâ‚    Î” âŠ¢ e' : Ï„ ! Eâ‚‚
  â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  Î“, Î” âŠ¢ let _ = e in e' : Ï„ ! Eâ‚ âˆª Eâ‚‚ âˆª {Drop<T>}
```
...
Phase 4: Verify Lifetimes
  For each borrow:
    - Verify borrow âŠ† borrowed value's lifetime
...
| A-04 Linear Types | owned â‰¡ affine | High |
...
6. **Linear Integration**: owned â‰¡ aff T + Drop
...
A-06 â”€â”€â”€â–¶â”‚ OWNERSHIP  â”‚â—€â”€â”€â”€ A-12 Regions
Unique   â”‚   TYPES    â”‚     Lifetimes
         â”‚  (A-13)    â”‚
...
**Next Session:** A-14 â€” Capability Types
