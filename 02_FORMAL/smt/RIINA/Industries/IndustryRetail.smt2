...
(define-fun consumer_sensitivity ((d ConsumerData)) Int true)

; all_rights_count (matches Coq: Definition all_rights_count)
(define-fun all_rights_count () Int true)

; right_to_nat (matches Coq: Definition right_to_nat)
(define-fun right_to_nat ((r PrivacyRight)) Int true)

; all_ecommerce_controls (matches Coq: Definition all_ecommerce_controls)
(define-fun all_ecommerce_controls ((c EcommerceControls)) Bool true)

; count_ecommerce_controls (matches Coq: Definition count_ecommerce_controls)
(define-fun count_ecommerce_controls ((c EcommerceControls)) Int true)

; retention_expired (matches Coq: Definition retention_expired)
(define-fun retention_expired () Bool true)
