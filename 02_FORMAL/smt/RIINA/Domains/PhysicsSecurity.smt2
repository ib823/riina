...
(define-fun reading_in_bounds ((r SensorReading)) Bool true)

; reading_valid (matches Coq: Definition reading_valid)
(define-fun reading_valid ((r SensorReading)) Bool true)

; spec_feasible (matches Coq: Definition spec_feasible)
(define-fun spec_feasible ((spec MeasurementSpec)) Bool true)
