...
(define-fun net_security_sound ((s NetworkSecurity)) Bool true)

; net_reliability_sound (matches Coq: Definition net_reliability_sound)
(define-fun net_reliability_sound ((r NetworkReliability)) Bool true)

; net_stack_verified (matches Coq: Definition net_stack_verified)
(define-fun net_stack_verified ((n VerifiedNetStack)) Bool true)

; riina_net_sec (matches Coq: Definition riina_net_sec)
(define-fun riina_net_sec () Bool true)

; riina_net_rel (matches Coq: Definition riina_net_rel)
(define-fun riina_net_rel () Bool true)

; riina_net_stack (matches Coq: Definition riina_net_stack)
(define-fun riina_net_stack () Bool true)
...
(define-fun tcp_transition ((st TCPState) (seg TCPSegment) (is_server Bool)) Bool true)

; is_connection_state (matches Coq: Definition is_connection_state)
(define-fun is_connection_state ((s TCPState)) Bool true)

; is_data_state (matches Coq: Definition is_data_state)
(define-fun is_data_state ((s TCPState)) Bool true)

; is_terminal_state (matches Coq: Definition is_terminal_state)
(define-fun is_terminal_state ((s TCPState)) Bool true)
