...
(define-fun tb_refill ((tb TokenBucket) (now Int)) Bool true)

; tb_available (matches Coq: Definition tb_available)
(define-fun tb_available ((tb TokenBucket)) Int true)
...
(define-fun cap_permits ((cap NetCapability) (port Int)) Bool true)
...
(define-fun hmac_compute ((key Int) (data Int)) Int true)

; syn_cookie_generate (matches Coq: Definition syn_cookie_generate)
(define-fun syn_cookie_generate ((secret Int) (cookie SynCookie)) Int true)

; syn_cookie_verify (matches Coq: Definition syn_cookie_verify)
(define-fun syn_cookie_verify ((secret Int) (cookie SynCookie) (mac Int)) Bool true)
