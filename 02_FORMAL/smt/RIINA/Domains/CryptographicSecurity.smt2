...
(define-fun ct_valid ((op ConstantTimeOp)) Bool true)

; riina_ct_op (matches Coq: Definition riina_ct_op)
(define-fun riina_ct_op () Bool true)

; key_secure (matches Coq: Definition key_secure)
(define-fun key_secure ((k CryptoKey)) Bool true)

; key_strong (matches Coq: Definition key_strong)
(define-fun key_strong ((k CryptoKey)) Bool true)

; riina_key (matches Coq: Definition riina_key)
(define-fun riina_key () Bool true)

; nonce_fresh (matches Coq: Definition nonce_fresh)
(define-fun nonce_fresh ((nt NonceTracker)) Bool true)

; nonce_counter_safe (matches Coq: Definition nonce_counter_safe)
(define-fun nonce_counter_safe ((nt NonceTracker)) Bool true)

; aead_secure (matches Coq: Definition aead_secure)
(define-fun aead_secure ((cfg AEADConfig)) Bool true)
