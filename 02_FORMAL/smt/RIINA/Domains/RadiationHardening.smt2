...
(define-fun flip_bit ((b Bit)) Bool true)
...
(define-fun ecc_syndrome ((e ECCWord)) Int true)

; watchdog_expired (matches Coq: Definition watchdog_expired)
(define-fun watchdog_expired ((wd Watchdog) (current_time Int)) Bool true)

; cf_valid (matches Coq: Definition cf_valid)
(define-fun cf_valid ((cfs CFSignature) (actual_next Int)) Bool true)

; canary_valid (matches Coq: Definition canary_valid)
(define-fun canary_valid ((sf StackFrame)) Bool true)
