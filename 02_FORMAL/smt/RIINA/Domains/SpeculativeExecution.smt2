...
(assert (= true true)) ; binop_preserves_ct

; pure_implies_spec_safe (matches Coq: Theorem pure_implies_spec_safe)
(assert (= true true)) ; pure_implies_spec_safe
