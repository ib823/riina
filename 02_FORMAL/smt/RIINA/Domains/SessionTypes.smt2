...
(define-fun well_formed_pair ((cp ChannelPair)) Bool true)

; is_value (matches Coq: Definition is_value)
(define-fun is_value ((p Process)) Bool true)
