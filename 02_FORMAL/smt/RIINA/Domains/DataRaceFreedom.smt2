...
(define-fun shared_compatible ((as_ AccessState)) Bool true)

; no_mixed_access (matches Coq: Definition no_mixed_access)
(define-fun no_mixed_access ((as_ AccessState)) Bool true)

; well_formed_ownership (matches Coq: Definition well_formed_ownership)
(define-fun well_formed_ownership ((om OwnershipMap)) Bool true)

; data_race (matches Coq: Definition data_race)
(define-fun data_race ((as_ AccessState) (l Loc)) Bool true)

; race_free (matches Coq: Definition race_free)
(define-fun race_free ((as_ AccessState)) Bool true)
