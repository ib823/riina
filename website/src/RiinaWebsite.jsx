...
const RiinaWebsite = () => {
  ...
  const releases = [
    // RELEASES_MARKER
    { version: '0.1.0', date: '2026-02-01', highlights: ['RIINA compiler with Bahasa Melayu syntax', 'Formal verification: 5,544 Qed proofs in Coq', 'Standard library: 88 builtins across 9 modules'] },
  ];
    ...
    <div>
      ...
      <section className="hero" style={{
        ...
        <div className="hero-stats" style={{
          ...
          {[
            { value: '5,544', label: 'Theorems Proven' },
          ...
          <div style={{ display: 'grid', gap: '48px', marginBottom: '64px' }}>
            ...
            <div style={{ padding: '32px', border: '2px solid #000' }}>
              ...
              <div style={{ marginTop: '24px', padding: '16px', backgroundColor: '#e8f5e9', fontSize: '13px', color: '#2e7d32' }}>
                5,544 machine-checked proofs guarantee security properties <em>before</em> the code runs.
              </div>
            </div>
          </div>
...
5,544 theorems verified in Coq. 0 admits. If the proof fails, compilation fails.`
            },
            {
              step: '04',
...
Every security claim has a machine-checked proof behind it.`
  ...
  const ResearchPage = () => (
    <div style={pageTopStyle}>
      <PageHeader
        title="Research"
        subtitle="RIINA is built on formal verification in Coq, with 5,544 machine-checked theorems across 249 files. Every security property has a proof."
      />
  ...
  const DocsPage = () => {
    const docCards = [
      ...
      { title: 'Formal Proofs', desc: '283 Coq files, 5,544 theorems', page: 'research',
