...
| Formal proofs ship with compiler | Yes (4,830 Qed theorems) | No | No | Partial |
...
| Proven theorems (Qed) | 4,830 (active build) |
...
| 3. Formal Verification | 4,830 Qed proofs, 4 justified axioms, 0 admits | Stable |
