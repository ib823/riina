...
|--------|----------|-------------|-------|
| **Coq 8.20.1** (Primary) | 7,025 Qed (active build), 0 Admitted, 0 active axioms | mechanized | 297 files declared in `_CoqProject`; 49 of those entries reference files that no longer exist in the worktree and are pending cleanup |
