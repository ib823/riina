...
--
-- Parent package for all RIINA cryptographic primitives.
-- Child packages:
--   - Riina.Crypto.AES    : AES-256 block cipher
--   - Riina.Crypto.SHA3   : SHA3-256 and SHAKE
--   - Riina.Crypto.ML_KEM : ML-KEM-1024 (post-quantum KEM)
--   - Riina.Crypto.ML_DSA : ML-DSA-65 (post-quantum signatures)

pragma SPARK_Mode (On);

package Riina.Crypto
   with Pure,
        SPARK_Mode => On
is
